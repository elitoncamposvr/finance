<div class="content">
    <div class="breadcrumb">
        <h2>Relatório Geral por Escola<i class="fas fa-angle-right fa-xs"></i> Selecionar Escola</h2>
    </div>
        ...
        <?php foreach ($school_list as $school) : ?>
            <div class="table_data">
                ...
                <div class="table-20 table-options txt-right">
                    <a class="btn" target="_blank" href="<?php echo BASE_URL; ?>reports/school_pdf/<?php echo $school['id']; ?>">Selecionar Escola</a>
                </div>
            </div>
        <?php endforeach; ?>
    <?php else : ?>
