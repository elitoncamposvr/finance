...
<div class="breadcrumb">
    <h2>Financeiro<i class="fas fa-angle-right fa-xs"></i>Contas a Receber<i class="fas fa-angle-right fa-xs"></i>Adicionar</h2>
    <span>
            ...
            <div class="w-40 my-s mr-m">
                ...
                <select name="client_name" id="client_name" class="w-100">
                    <?php foreach ($client_list as $c) : ?>
                        <option value="<?php echo $c['id']; ?>"><?php echo $c['client_name']; ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
