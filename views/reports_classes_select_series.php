<div class="content">
    <div class="breadcrumb">
        <h2>Relatório por Turma<i class="fas fa-angle-right fa-xs"></i> Selecionar Série</h2>
    </div>
    ...
    <?php if ($series_list) : ?>
        ...
        <?php foreach ($series_list as $series) : ?>
            <div class="table_data">
                <div class="table-20"><span class="table-title-mobile">Série:</span><?php echo $series['series_name']; ?>&ordf;</div>
                ...
                <div class="table-20 table-options txt-right">
                    <a class="btn" href="<?php echo BASE_URL; ?>reports/classes_selectclasses/<?php echo $series['id']; ?>">Selecionar Série</a>
                </div>
            </div>
        <?php endforeach; ?>
    <?php else : ?>
