...
<div class="breadcrumb">
    <h2>Comissões<i class="fas fa-angle-right fa-xs"></i>Relatório de Comissões</h2>
    <span>
...
<div class="content">
    ...
    <div class="flex my-3">
        <form action="<?php echo BASE_URL; ?>report/comissions_pdf" method="get" class="flex w-100 wrap" target="_blank">
        <div class="table-30">
