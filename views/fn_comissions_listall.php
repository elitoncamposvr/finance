...
<div class="breadcrumb">
    <h2>Financeiro<i class="fas fa-angle-right fa-xs"></i>Comissões<i class="fas fa-angle-right fa-xs"></i>Listar todas</h2>
    <span>
        <a class="btn" href="<?php echo BASE_URL; ?>financial/comissions"><i class="fas fa-angle-double-left"></i> Voltar</a>
    </span>
</div>
