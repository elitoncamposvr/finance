...
<div class="breadcrumb">
    <h2>Custo Médio<i class="fas fa-angle-right fa-xs"></i>Relatório de Custo</h2>
    <span>
...
<div class="content">
    ...
    <div class="flex my-3">
        <form action="<?php echo BASE_URL; ?>report/averagecost_pdf" method="get" class="flex w-100 wrap" target="_blank">
        <div class="table-30">
