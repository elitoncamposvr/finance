<div class="content">
    <div class="breadcrumb">
        <h2>Relatório por Aluno<i class="fas fa-angle-right fa-xs"></i> Selecionar Turma</h2>
    </div>
    ...
    <?php if ($classes_list) : ?>
        <div class="table_header">
            ...
            <div class="table-20">Selecionar Turma</div>
        </div>
        ...
        <?php foreach ($classes_list as $classes) : ?>
            <div class="table_data">
                ...
                <div class="table-20 table-options txt-right">
                    <a class="btn" href="<?php echo BASE_URL; ?>reports/students_selectstudents/<?php echo $classes['id']; ?>">Selecionar Turma</a>
                </div>
            </div>
        <?php endforeach; ?>
    <?php else : ?>
