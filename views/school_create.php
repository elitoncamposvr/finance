<div class="content">
	<div class="breadcrumb">
		<h2>Escolas<i class="fas fa-angle-right fa-xs"></i>Adicionar</h2>
		<span>
	...
	<form method="POST" autocomplete="off">
		<div class="table-line">
			<div class="table-60 my-s space-input">
				...
				<input class="w-100" type="text" name="school_name" id="school_name" autofocus required>
			</div>
			<div class="table-40 my-s">
				<label for="head_school">Responsável</label>
				<input class="w-100" type="text" name="head_school" id="head_school">
			</div>
		</div>
