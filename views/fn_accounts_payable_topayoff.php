...
<div class="breadcrumb">
    <h2>Financeiro<i class="fas fa-angle-right fa-xs"></i>Contas a Pagar<i class="fas fa-angle-right fa-xs"></i>Quitar Conta</h2>
    <span>
...
<div class="content">
    ...
    <div class="data_info my-m">
        ...
        <p>
            <span class="bold">Nº Doc. </span><?php echo $accounts_payable_info['doc_number']; ?>
        </p>
    </div>
