...
<div class="breadcrumb">
    <h2>Configurações<i class="fas fa-angle-right fa-xs"></i>Financeiro<i class="fas fa-angle-right fa-xs"></i>Portador/Carteira<i class="fas fa-angle-right fa-xs"></i>Editar</h2>
    <span>
