...
class Permissions extends model{
	...
	public function getList($id_company){
		...
		$sql = $this->db->prepare("SELECT * FROM permission_params WHERE id_company = :id_company ORDER BY permission_title ASC");
		$sql->bindValue(':id_company', $id_company);
		$sql->execute();
	...
	public function add($name, $permission_title, $id_company){
		

		$sql = $this->db->prepare("INSERT INTO permission_params SET name = :name, permission_title = :permission_title, id_company = :id_company");
