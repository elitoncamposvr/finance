...
class Schedule extends model
{
    ...
    {
        $sql = $this->db->prepare("INSERT INTO schedule SET client_id = :client_id, id_user = :id_user, situation = 1, discount = 0, id_company = :id_company");
    ...
    {
        $sql = $this->db->prepare("UPDATE schedule_services SET status = 2 WHERE date_service < NOW() AND aproved = 2");
        $sql->execute();

        $sql = $this->db->prepare("UPDATE schedule SET situation = 2 WHERE schedule_date < NOW() AND situation = 4");
        $sql->execute();
    }
    ...
    public function setAproved($id, $payment, $schedule_date, $id_user, $id_company)
    {

        $sql = $this->db->prepare("UPDATE schedule SET situation = 4, payment = :payment, schedule_date = :schedule_date WHERE id = :id AND id_company = :id_company");

        $sql->bindValue(":id", $id);
        $sql->bindValue(":payment", $payment);
        $sql->bindValue(":schedule_date", $schedule_date);
        $sql->bindValue(":id_company", $id_company);
        $sql->execute();
    ...
    public function addAditionalInfo($id, $aditional_info, $id_user, $id_company)
    {

        $sql = $this->db->prepare("UPDATE schedule SET aditional_info = :aditional_info WHERE id = :id AND id_company = :id_company");
        ...
        $this->setLog($id, $id_company, $id_user, 'adicionou informações adicionais');
    }
    ...
    public function addVoucher($schedule_id, $voucher_name, $payment, $id_user, $id_company)
    {
        $sql = $this->db->prepare("INSERT INTO schedule_voucher SET schedule_id = :schedule_id, voucher_name = :voucher_name, payment = :payment, id_user = :id_user, id_company = :id_company");
