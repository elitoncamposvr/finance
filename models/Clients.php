...
class Clients extends model{
	...
	public function add($id_company, $client_name,  $email = '', $phone = '', $cellphone = '', $whatsapp = '',  $cpf = '', $identity = '', $birth_date = '', $aditional_info = '', $address_zipcode = '', $address = '', $address_number = '', $address2 = '', $address_neighb = '', $address_city = '', $address_state = ''){

		$sql = $this->db->prepare("INSERT INTO  clients SET id_company = :id_company, client_name = :client_name, email = :email, phone = :phone, cellphone = :cellphone, whatsapp = :whatsapp, cpf = :cpf, identity = :identity, birth_date =:birth_date, aditional_info = :aditional_info, address_zipcode = :address_zipcode, address = :address, address_number = :address_number, address2 = :address2, address_neighb = :address_neighb, address_city = :address_city, address_state = :address_state, date_register = NOW()");
		$sql->bindValue(":id_company", $id_company);
	...
	public function edit($id, $id_company, $client_name, $email, $phone, $cellphone, $whatsapp, $cpf, $identity, $birth_date, $aditional_info, $address_zipcode, $address, $address_number, $address2, $address_neighb, $address_city, $address_state, $date_register){

		$sql = $this->db->prepare("UPDATE clients SET client_name = :client_name, email = :email, phone = :phone, cellphone = :cellphone, whatsapp = :whatsapp, cpf = :cpf, identity = :identity, birth_date =:birth_date, aditional_info = :aditional_info, address_zipcode = :address_zipcode, address = :address, address_number = :address_number, address2 = :address2, address_neighb = :address_neighb, address_city = :address_city, address_state = :address_state, date_register = :date_register WHERE id = :id AND id_company = :id_company");
		$sql->bindValue(":id", $id);
		$sql->bindValue(":id_company", $id_company);
				$sql->bindValue(":client_name", $client_name);
		$sql->bindValue(":email", $email);
