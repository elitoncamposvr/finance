...
class scheduleController extends controller
{
	...
	public function aditionalinfo()
	{
		...
		if ($u->hasPermission('schedule')) {
			...
			if (isset($_POST['aditional_info']) && !empty($_POST['aditional_info'])) {
				$id = addslashes($_POST['id']);
				$aditional_info = addslashes($_POST['aditional_info']);

				$sh->addAditionalInfo($id, $aditional_info, $u->getId(), $u->getCompany());
	...
	public function voucher()
	{
		...
		if (isset($_POST['form_voucher']) && !empty($_POST['form_voucher'])) {
			...
			$sh->addVoucher($schedule_id, $voucher_name, $payment, $u->getId(), $u->getCompany());
	...
	public function aprove($id)
	{
		...
		if ($u->hasPermission('schedule_cancel')) {
			...
			$sh->setAproved($id, $payment, $schedule_date, $u->getId(), $u->getCompany());
			header("Location: " . BASE_URL . "schedule/view/".$id);
